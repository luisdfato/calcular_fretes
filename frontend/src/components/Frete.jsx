...
const Frete = () => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-red-900 p-4">
            <div className="bg-amber-600 p-8 rounded-2xl shadow-2xl w-full">
                <h1 className="text-3x1 font-bold text-blue-950 mb-6">Calculadora de Frete</h1>
                <form onSubmit={handleFrete} className="space-y-6"> 
                    <div className="space-y-2 text-left">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 border-gray-700 rounded-2xl focus:outline-none- focus:right-2 focus:ring-blue-950"
                        />
                    </div>
                    <div>
